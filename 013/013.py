...
orcamentoProjetos = [0] * QUANTIDADE_PROJETOS

def LeCodigoProjeto():
    codigoProjeto = -1
    codigoProjetoValido = False
    while not codigoProjetoValido:
        msg = 'Digite o codigo do projeto[1-{lim}] (0 para sair): '.format(lim=QUANTIDADE_PROJETOS)
...
def main():
    ...
    while codigoProjeto != 0:
        ...
        if codigoProjeto > 0:
            ...
            break  # Encerra o loop quando o código do projeto for 0
